...
\makeatother
\usepackage{flushend} % making the last page balanced
\usepackage{cleveref}
\usepackage{multirow}
...
\newcommand{\AUTHORS}{Shuai Mu, Lamont Nelson, Wyatt Lloyd, and Jinyang Li}
...
%% \newcommand{\TITLE}{Capacity under Conflicts by Consolidating \\
%%   Concurrency Control and Consensus}
\newcommand{\TITLE}{Consolidating Concurrency Control and Consensus\\ for Commits under Conflicts}
...
\date{}
\title{\textbf{\TITLE}}
\author{{\large Shuai Mu$^\star$, Lamont Nelson$^\star$, Wyatt Lloyd$^\dag$, and Jinyang Li$^\star$}\\
\textit{$^\star$New York University, $^\dag$University of Southern California}}
